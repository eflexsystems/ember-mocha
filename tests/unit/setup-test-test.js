...
describe('setupTest', function () {
  ...
  describe('hooks API', function () {
    describe('calls hooks in order', function () {
      ...
      after(function () {
        expect(calledSteps, 'hooks are called in correct order').to.deep.equal([
          'bE1',
          'bE2',
          'it',
          'aE2',
      ...
      hooks.afterEach(function () {
        expect(calledSteps, 'afterEach is called in LIFO order').to.deep.equal([
          'bE1',
          'bE2',
          'it',
        ]);
    ...
    describe('is Promise aware', function () {
      ...
      hooks.afterEach(function () {
        expect(calledSteps, 'afterEach waits for promise').to.deep.equal([
          'bE1',
          'bE2',
          'it',
          'aE2',
